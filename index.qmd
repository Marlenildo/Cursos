...
## <i class="fa-brands fa-r-project"></i> Estrutura do Curso
...
## <i class="fas fa-code"></i> Exemplos de Códigos
...
- [Conteúdo do Curso (Estrutura e Códigos)](#conteúdo-do-curso)
- [Quem Sou](#quem-sou)
